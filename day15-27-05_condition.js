// Q.Check number if it is lesser than 100/150/200
// var num=450;
// if(num<100){
//     console.log(num,"is lesser than 100")
// }
// else if(num<150){
//     console.log(num,"is lesser than 150")
// }
// else if(num<200){
//     console.log(num,"is lesser than 200")
// }
// else if(num>200 && num<500){
//     console.log(num,"is between the 200 & 500!!!!!")
// }
// else if(num<500 || num>1000){
//     console.log("Its Random number")
// }
// else{
